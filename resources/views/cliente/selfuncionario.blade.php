    ...
    <br>
   	<div class="col s12 m4 offset-m4">
     	<div class="card-panel blue-color-black">
     		...
     		@endif
     		@if ($funcionario->id == 1)
     			<span class="white-text">Queremos generar satisfaccion y confianza a nuestros clientes, por lo cual seleccionaremos una de nuestras funcionarias disponibles.<br><br>
     			Recibiras todos los datos de nuestra funcionaria via correo electronico. <br><br>
                <a href="/micuenta" class="btn green-color">Aceptar</a>
	        	</span>
     		@endif
      	</div>
