...
<div class="row blue-color white-text sin-espacio">
	<div class="container">
		<div class="col s12 center">
			<h1 class="titulo">politica de servicio</h1>
		</div>
		<div class="col s12">
			<p><b>1.</b> Debes reservar el servicio y realizar el pago del servicio para que nuestro personal acuda el día requerido.</p>
